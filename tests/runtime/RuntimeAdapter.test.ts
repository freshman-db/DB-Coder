...
import {
  ...
  clearRuntimes,
  findRuntimeForModel,
} from "../../src/runtime/runtimeFactory.js";
...
import { CodexCliRuntime } from "../../src/runtime/CodexCliRuntime.js";
...
test("getRuntime: codex-sdk throws when not registered", async () => {
  ...
  const { getRuntime } = await import("../../src/runtime/runtimeFactory.js");
